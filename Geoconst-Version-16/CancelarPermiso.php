							...
							<section class="split">
								<section>
									...
									<form action="CancelarPermiso.php" method="POST">
										...
										<select name="Motivo" required="true" >
											
										<option value="Recursos">	   1)    No hay recursos económicos para solventar el viaje</option>

                                        <option value="Compete"> 2)    La salida no compete a la carrera</option>

                                        <option value="Sin valor">3)    La salida no aporta algún valor a la carrera</option>

                                        <option value="Fuera de tiempo">4)    Escasez de tiempo para realizar la salida</option>

                                        <option value="Traslape">       5)    La salida colisiona con otras actividades académicas de uno o más de los integrantes</option>

                                        <option value="Información insuficiente">6)    La información sobre el evento es insuficiente</option>

                                        <option value="Seguridad">7)    El viaje supone algún riesgo de seguridad</option>

                                        <option value="Otro">       8)    Otro motivo</option>
											
										</select>
							
										Descripción : <textarea name="Descripcion" id="Descripcion" cols="30" rows="10"></textarea>
										<input type="hidden" name="Fols" value="<?=$field?>"  >
										<div class="centrado">
										<input type="submit" name=ComentariosSB value="Enviar" class="special" >
									</div>
